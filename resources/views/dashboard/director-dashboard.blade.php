    ...
    <style>
        ...
        .hero-panel {
            ...
            background:
                ...
                linear-gradient(135deg, #0f766e 0%, #0f5ba8 55%, #1d4ed8 100%);
            color: #fff;
            box-shadow: 0 24px 70px rgba(15, 91, 168, 0.22);
        }
...
@section('content')
    ...
    <div class="container-fluid director-dashboard">
        ...
        <div class="metric-grid">
            <div class="metric-card">
                <div class="metric-head">
                    <div>
                        <div class="subtle">Jamoa xodimlari</div>
                        <h3>{{ $teamSize }}</h3>
                    </div>
            ...
            <div class="metric-card">
                <div class="metric-head">
                    <div>
                        <div class="subtle">Bo'lim KPI bajarilishi</div>
                ...
                <div class="progress-rail">
                    <div class="progress-fill" style="width: {{ min($completionRate, 100) }}%; background: linear-gradient(90deg, #0f766e, #2dd4bf);"></div>
                </div>
            </div>
            ...
            <div class="metric-card">
                <div class="metric-head">
                    <div>
                        <div class="subtle">Bo'lim balli</div>
                ...
                <div class="progress-rail">
                    <div class="progress-fill" style="width: {{ min($scoreRate, 100) }}%; background: linear-gradient(90deg, #7c3aed, #c084fc);"></div>
                </div>
            </div>
            ...
            <div class="metric-card">
                <div class="metric-head">
                    <div>
                        <div class="subtle">Nazoratdagi topshiriqlar</div>
                        <h3>{{ $pendingTasks }}</h3>
                    </div>
                ...
                <div class="progress-rail">
                    <div class="progress-fill" style="width: {{ min($totalTasks > 0 ? round(($pendingTasks / $totalTasks) * 100) : 0, 100) }}%; background: linear-gradient(90deg, #ea580c, #fb923c);"></div>
                </div>
            </div>
        </div>
        ...
        <div class="panel-grid">
            <div class="surface-card">
                ...
                @if($sectionResults->isEmpty())
                    <div class="empty-state">
                        Bo'lim natijalari uchun ma'lumot topilmadi.
                    </div>
                @else
                        ...
                        @foreach($sectionResults as $section)
                            <div class="section-card">
                                ...
                                <div class="section-stats">
                                    ...
                                    <div class="section-stat">
                                        <strong>{{ number_format($section['current_score'], 1) }}</strong>
            ...
            <div class="surface-card">
                <div>
                    <h4>Bo'lim KPI holatlari</h4>
                    <div class="subtle">Joriy oy bo'yicha KPI taqsimoti.</div>
                </div>

                <div class="ring-chart">
                    <svg viewBox="0 0 180 180" width="100%" height="220" role="img" aria-label="Bo'lim KPI holatlari">
        ...
        <div class="panel-grid">
            <div class="surface-card">
                <div>
                    <h4>Bo'limning 6 oylik natijalari</h4>
                    <div class="subtle">Har oy uchun bo'lim KPI bajarilish foizi.</div>
                </div>

                <div class="diagram-wrap">
                    <svg viewBox="0 0 360 180" width="100%" height="220" role="img" aria-label="Bo'lim natijalari diagrammasi">
                        <defs>
                            <linearGradient id="directorLineFill" x1="0%" x2="100%" y1="0%" y2="0%">
                        ...
                        <polyline points="{{ $points }}" fill="none" stroke="url(#directorLineFill)" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <div class="surface-card">
                <div>
                    <h4>Bo'lim monitoringi</h4>
                    <div class="subtle">Muhim ko'rsatkichlar bo'yicha tezkor ko'rinish.</div>
                </div>
        ...
        <div class="panel-grid">
            <div class="surface-card">
                <div>
                    ...
                    <div class="subtle">Bo'limdagi eng yaxshi natija ko'rsatayotgan xodimlar.</div>
                </div>

                @if($focusKpis->isEmpty())
                    <div class="empty-state">
                        Hozircha bo'lim xodimlari bo'yicha ma'lumot mavjud emas.
                    </div>
                @else
            ...
            <div class="surface-card">
                <div>
                    <h4>Bo'limdagi so'nggi topshiriqlar</h4>
                    <div class="subtle">Yaqinda qo'shilgan topshiriqlar va ularning holati.</div>
                </div>
                            ...
                            <div class="task-row">
                                <div class="d-flex justify-content-between align-items-start gap-3">
                                    <div>
                                        ...
                                        <div class="subtle mt-1">{{ optional(optional($task->user_kpi)->user)->full_name ?: 'Xodim noma\'lum' }}</div>
                                    </div>
