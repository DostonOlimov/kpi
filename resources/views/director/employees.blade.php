                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-muted mb-1 small">Jami shaxsiy kpi ko'rsatkichlari</h6>
                                    <h3 class="mb-0 fw-bold text-dark">{{ $users->sum(function($user) { return $user->user_kpis->filter(fn ($userKpi) => $userKpi->kpi?->type == \App\Models\Kpi::SELF_BY_PERSON)->count(); }) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <h3 class="mb-0 fw-bold text-dark">{{ $users->sum(function($user) { return $user->user_kpis->filter(fn ($userKpi) => $userKpi->kpi?->type == \App\Models\Kpi::SELF_BY_PERSON)->whereNotNull('current_score')->count(); }) }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    @php
                                        $totalTasks = $users->sum(function($user) { return $user->user_kpis->filter(fn ($userKpi) => $userKpi->kpi?->type == \App\Models\Kpi::SELF_BY_PERSON)->count(); });
                                        $completedTasks = $users->sum(function($user) { return $user->user_kpis->filter(fn ($userKpi) => $userKpi->kpi?->type == \App\Models\Kpi::SELF_BY_PERSON)->whereNotNull('current_score')->count(); });
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0" id="employeesTable">
                                ...
                                @foreach ($users as $index => $employee)
                                    @php
                                        $totalTasks = $employee->user_kpis->filter(fn ($userKpi) => $userKpi->kpi?->type == \App\Models\Kpi::SELF_BY_PERSON)->count();
                                        $checkedTasks = $employee->user_kpis->filter(fn ($userKpi) => $userKpi->kpi?->type == \App\Models\Kpi::SELF_BY_PERSON)->whereNotNull('current_score')->count();
