                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-muted mb-1 small">Bajarilgan</h6>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0" id="employeesTable">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="border-0 px-4 py-3 fw-semibold text-dark">Topshiriqlar holati</th>
                                    <th scope="col" class="border-0 px-4 py-3 fw-semibold text-dark">Bajarilish foizi</th>
                                ...
                                @foreach ($users as $index => $employee)
                                    @php
                                        ...
                                        $checkedTasks = $employee->tasks->where('is_checked', true)->count();
                                    ...
                                    <tr class="employee-row" data-completion="{{ $completionPercentage }}" data-status="{{ $statusClass }}">
                                                ...
                                                <div class="row g-2 mb-2">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="stat-item text-center p-2 bg-light rounded">
                                                            ...
                                                            <small class="text-muted">Bajarilgan</small>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="progress-container">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <small class="text-muted">Bajarilish</small>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="action-buttons">
                                                <a href="{!! url('director-profile/check-user' , $employee) !!}"
